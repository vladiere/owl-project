...
/// The clean content to hash with salt.
///
/// NOTE:
///     - Since content is sensitive information, we DO NOT implement default debug for the struct.
...
pub async fn validate_pwd(
    ...
    //      doing a spawn_blocking to avoid it.
